  ...
  return (
    <div className="card">
      <div className="logo">
        ...
        <div>
          <div className="logo-text">AbsenQR</div>
          <div className="logo-sub">Sistem Presensi Digital</div>
        </div>
      </div>
...
function PageLoginPeserta({ onBack, onLogin }) {
  ...
  return (
    <div className="card">
      <div className="logo">
        <div className="logo-dot">📋</div>
        <div><div className="logo-text">AbsenQR</div></div>
      </div>
      ...
      <div className="form-group">
        ...
        <input className="input" placeholder="Contoh: 107" value={nic}
...
function PageLoginAdmin({ onBack, onLogin }) {
  ...
  return (
    <div className="card">
      ...
      <div className="form-sub">Default: admin / admin123</div>
      {err && <div className="alert alert-error">⚠ {err}</div>}
      <div className="form-group">
